                    ...
                    <SpotlightCard>
                        <div className={`${inter.className} px-10 my-44 mx-auto flex flex-col lg:px-0 px-auto lg:w-1/2 max-w-5xl`}>
                            ...
                            <div id={"Education"} className="mt-20 flex flex-col space-y-3 scroll-mt-24 px-5 py-5">
                                ...
                                <Link href={"files/Maxwell Wang's Resume 2024.pdf"} target="_blank" rel="noopener noreferrer">
                            ...
                            <div id={"Experience"} className="mt-20 flex flex-col space-y-3 scroll-mt-24 px-5 py-5">
                                ...
                                <Experience start="August 2024" end="Present" title="Northrop Grumman" jobTitle="Software Engineer" description="Developed and design a simulation game using godot, blender modeling and wrote c++ code to enhance the functionality of the simulation. Gained Experience as a Deputy Product owner and then Scrum Master, facilitating and attending meetings."/>
                                ...
                                <Experience start="Feb 2023" end="May 2023" title="University of Delaware Computer & Info. Sciences" jobTitle="Teaching Assistant" description="I instruct CISC 437, focusing on Database Systems, where I cover topics such as SQL, data retrieval languages, and the principles of security, integrity, as well as the physical and logical organization of databases."/>
                                <Experience start="Feb 2024" end="May 2024" title="University of Delaware Computer & Info. Sciences" jobTitle="Teaching Assistant" description="Additionally, I actively engage with students through office hours, conduct exams and quizzes, and provide clear and constructive feedback to a cohort of 50-60 students. Additionally as duty as an proctor TA, it is my responsibility to schedule exams, whether it be makeup or for computer science courses and to make sure there is not a time constraint in students schedule and the exam schedule. I also report to the TA coordinator about scheduling issues, and whether slots for scheduling exams are avaliable."/>
